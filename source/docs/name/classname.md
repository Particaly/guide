...
ClassName的命名应该尽量精短、明确，必须以**字母开头命名**，单词之间**统一使用短横线** “-” 连接

## 单文件组件

对于单文件组件内部，root级的div的classname应当具有全局唯一性

每个单文件组件的`export`必须具有`name`属性，且该属性的值应当具有全局唯一性
